...
"";
    ...
    public boolean them(ChiTietSanPham chiTiet) throws SQLException {
        Connection conn = DBConnection.getConnection();
        String sql = "insert into CHITIETSANPHAM (SOIMEI,MOTA,GIANHAP,GIABAN,THOIGIANBAOHANH,IDSANPHAM,IDHEDIEUHANH,IDCAMERA,IDRAM,IDKICHTHUOCMANHINH,IDCPU,IDBONHOTRONG,IDLOAIPIN,IDTANSOQUET,IDDUNGLUONGPIN,TRANGTHAI) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,0)";
        PreparedStatement ps = conn.prepareStatement(sql);
