...
public class form_home extends javax.swing.JPanel {
    ...
    public form_home() {
     ...
     private void initCardData() {
        ...
        card1.setData(new ModelCard("Tổng Khách Hàng", 5100, 20, icon1));
        Icon icon2 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.MONETIZATION_ON, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card2.setData(new ModelCard("Doanh Số / Ngày", 2000, 60, icon2));
...
private void initNoticeBoard() {
        ...
        noticeBoard.addNoticeBoard(new ModelNoticeBoard(new Color(94, 49, 238), "Lưu ý", "Now", "Bạn đặt hàng vui lòng kiểm tra kỹ lại thông tin sản phẩm"));
        noticeBoard.addNoticeBoard(new ModelNoticeBoard(new Color(218, 49, 238), "Thời gian làm việc", "2h ago", "Thời gian mở cửa shop từ 6h00 tới 23h00. Làm việc cả thứ bảy và chủ nhật"));
         noticeBoard.addDate("Hướng dẫn sử dụng phần mềm Bán Điện Thoại");
